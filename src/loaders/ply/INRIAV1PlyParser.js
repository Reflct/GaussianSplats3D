...
exports.INRIAV1PlyParser = void 0;
...
const [SCALE_0, SCALE_1, SCALE_2, ROT_0, ROT_1, ROT_2, ROT_3, X, Y, Z, F_DC_0, F_DC_1, F_DC_2, OPACITY, RED, GREEN, BLUE, F_REST_0,] = BaseFieldsToReadIndexes;
class INRIAV1PlyParser {
    ...
    static decodeHeaderLines(headerLines) {
        ...
        const header = PlyParserUtils_1.PlyParserUtils.decodeSectionHeader(headerLines, fieldNameIdMap, 0);
        return {
            ...header,
    ...
    static decodeHeaderText(headerText) {
        ...
        return {
            ...
            headerSizeBytes: headerText.indexOf(PlyParserUtils_1.PlyParserUtils.HeaderEndToken) +
    ...
    static parseToUncompressedSplatBufferSection(header, fromSplat, toSplat, splatData, splatDataOffset, toBuffer, toOffset, outSphericalHarmonicsDegree = 0) {
        ...
        for (let i = fromSplat; i <= toSplat; i++) {
            ...
            SplatBuffer_1.SplatBuffer.writeSplatDataToSectionBuffer(parsedSplat, toBuffer, outBase, 0, outSphericalHarmonicsDegree, bucketCenter, compressionScaleFactor, compressionScaleRange);
        }
    }
    /**
    ...
    static decodeSectionSplatData(sectionSplatData, splatCount, sectionHeader, outSphericalHarmonicsDegree, toSplatArray = true) {
        ...
        if (toSplatArray) {
            ...
            const { splatBuffer, splatBufferDataOffsetBytes } = SplatBuffer_1.SplatBuffer.preallocateUncompressed(splatCount, outSphericalHarmonicsDegree);
    ...
    static readSplat(splatData, header, row, dataOffset, rawSplat) {
        return PlyParserUtils_1.PlyParserUtils.readVertex(splatData, header, row, dataOffset, header.fieldsToReadIndexes, rawSplat, true);
    }
    /**
 ...
 */
INRIAV1PlyParser.parseToUncompressedSplat = (function () {
    let rawSplat = [];
