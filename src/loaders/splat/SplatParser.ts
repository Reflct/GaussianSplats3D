...
export class SplatParser {
  ...
  /**
   * Parse splat data to an uncompressed splat buffer section
   * @param fromSplat - Starting splat index
   * @param toSplat - Ending splat index
   * @param fromBuffer - Source buffer
   * @param fromOffset - Offset in source buffer
   * @param toBuffer - Destination buffer
   * @param toOffset - Offset in destination buffer
   */
  ...
  /**
   * Parse splat data to an uncompressed splat array section
   * @param fromSplat - Starting splat index
   * @param toSplat - Ending splat index
   * @param fromBuffer - Source buffer
   * @param fromOffset - Offset in source buffer
   * @param splatArray - Destination splat array
   */
  ...
  /**
   * Parse standard splat data to an uncompressed splat array
   * @param inBuffer - Buffer containing splat data
   * @returns Uncompressed splat array
   */
  static parseStandardSplatToUncompressedSplatArray(
