...
exports.UncompressedSplatArray = void 0;
const Util_1 = require("../Util");
const BASE_COMPONENT_COUNT = 14;
class UncompressedSplatArray {
    constructor(sphericalHarmonicsDegree = 0) {
        this.sphericalHarmonicsDegree = sphericalHarmonicsDegree;
        this.sphericalHarmonicsCount = (0, Util_1.getSphericalHarmonicsComponentCountForDegree)(this.sphericalHarmonicsDegree);
    ...
    static createSplat(sphericalHarmonicsDegree = 0) {
        ...
        let shEntries = (0, Util_1.getSphericalHarmonicsComponentCountForDegree)(sphericalHarmonicsDegree);
